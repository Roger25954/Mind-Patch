...
// Pre-generado fuera del componente para evitar re-cálculo en cada render
...
function SquaresAnimation() {
  ...
  useEffect(() => {
    ...
    // Pausar cuando la sección no está visible en pantalla
...
const PhoneIcon = () => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.18 2 2 0 0 1 3.6 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.6a16 16 0 0 0 6 6l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.92 16z" />
  </svg>
)
const MapIcon = () => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
...
function Field({ label, type = 'text', as = 'input', value, onChange }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '7px' }}>
      <label style={{ color: 'rgba(255,255,255,0.3)', fontSize: '11px', letterSpacing: '1.5px', textTransform: 'uppercase' }}>
        {label}
      </label>
      {as === 'textarea' ? (
        <textarea
...
export function ContactSection() {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <h2 style={{
            ...
            Hablemos sobre<br />
            <span style={{ color: 'rgb(107,114,128)' }}>tu bienestar mental</span>
          </h2>
          <p style={{ marginTop: '16px', color: 'rgb(107,114,128)', fontSize: '17px', lineHeight: 1.7, maxWidth: '440px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {contactInfo.map((item) => (
                ...
                >
                  ...
                  <div>
                    <p style={{ color: 'rgba(255,255,255,0.28)', fontSize: '10px', letterSpacing: '1.5px', textTransform: 'uppercase', margin: '0 0 4px' }}>
                      {item.label}
                    </p>
            ...
            <div style={{
              ...
              {sent ? (
                ...
                >
                  ...
                  <p style={{ color: 'white', fontSize: '16px', fontWeight: 600, margin: '0 0 8px' }}>
                    Mensaje enviado
                  </p>
      ...
      {/* Animacion de cuadros en esquina inferior derecha */}
      <SquaresAnimation />
    </section>
  )
}
