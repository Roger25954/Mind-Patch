  ...
  _getCols(key, m) {
    ...
    if (key === 'palabras' && m.precisionReales !== undefined) {
      return [
        ...
        { label: 'DISOCIACIÓN', val: (m.disociacion > 0 ? '+' : '') + m.disociacion + 'pts' }, // NUEVO
        { label: 'VEL. REALES', val: m.velMediaReales + 'ms' },   // NUEVO
        { label: 'VEL. PSEUDOS', val: m.velMediaPseudos + 'ms' },  // NUEVO
