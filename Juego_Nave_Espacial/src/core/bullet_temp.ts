/**
 * Clase Bullet (versión temporal): Representa un proyectil disparado por la nave.
 *
 * Nota: este archivo es un vestigio de prototipado. La clase definitiva está en
 * `src/core/bullet.ts` y se debe usar esa implementación para producción.
 */
...
export class Bullet {
  ...
  // Sprite del halo luminoso (billboard)
   ...
   */
  private static createGlowTexture() {
    const size = 128
